...
// These map our existing type names to the spec-canonical names above.
// ---------------------------------------------------------------------------

type (
	// AnnouncementResponse is an alias for Announcement (backward compatibility).
	AnnouncementResponse = Announcement
	// BatchCancelEntry is an alias for BatchCancelOrdersIndividualResponse (backward compatibility).
	BatchCancelEntry = BatchCancelOrdersIndividualResponse
	// BatchCancelOrderEntry is an alias for BatchCancelOrdersRequestOrder (backward compatibility).
	BatchCancelOrderEntry = BatchCancelOrdersRequestOrder
	// BatchCancelRequest is an alias for BatchCancelOrdersRequest (backward compatibility).
	BatchCancelRequest = BatchCancelOrdersRequest
	// BatchCancelResponse is an alias for BatchCancelOrdersResponse (backward compatibility).
	BatchCancelResponse = BatchCancelOrdersResponse
	// BatchCreateEntry is an alias for BatchCreateOrdersIndividualResponse (backward compatibility).
	BatchCreateEntry = BatchCreateOrdersIndividualResponse
	// BatchCreateRequest is an alias for BatchCreateOrdersRequest (backward compatibility).
	BatchCreateRequest = BatchCreateOrdersRequest
	// BatchCreateResponse is an alias for BatchCreateOrdersResponse (backward compatibility).
	BatchCreateResponse = BatchCreateOrdersResponse
	// Candlestick is an alias for MarketCandlestick (backward compatibility).
	Candlestick = MarketCandlestick
	// CandlestickOHLC is an alias for BidAskDistribution (backward compatibility).
	CandlestickOHLC = BidAskDistribution
	// CandlestickPriceOHLC is an alias for PriceDistribution (backward compatibility).
	CandlestickPriceOHLC = PriceDistribution
	// EventDetail is an alias for EventData (backward compatibility).
	EventDetail = EventData
	// EventPositionResponse is an alias for EventPosition (backward compatibility).
	EventPositionResponse = EventPosition
	// FillResponse is an alias for Fill (backward compatibility).
	FillResponse = Fill
	// MarketDetail is an alias for Market (backward compatibility).
	MarketDetail = Market
	// MarketPositionResponse is an alias for MarketPosition (backward compatibility).
	MarketPositionResponse = MarketPosition
	// OrderResponse is an alias for Order (backward compatibility).
	OrderResponse = Order
	// SeriesDetail is an alias for Series (backward compatibility).
	SeriesDetail = Series
	// SettlementResponse is an alias for Settlement (backward compatibility).
	SettlementResponse = Settlement
	// SingleCreateResponse is an alias for CreateOrderResponse (backward compatibility).
	SingleCreateResponse = CreateOrderResponse
	// TradeResponse is an alias for Trade (backward compatibility).
	TradeResponse = Trade
)
