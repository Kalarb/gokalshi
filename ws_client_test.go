...
func TestMsgTypeToChannel(t *testing.T) {
	expected := map[WSMessageType][]string{
		...
		WSMsgCfbenchmarksValue5Hz:          {"cfbenchmarks_value_5hz"},
		WSMsgCfbenchmarksValue5HzIndexlist: {"cfbenchmarks_value_5hz"},
		WSMsgPythValue:                     {"pyth_value"},
		WSMsgPythValueUnderlyingList:       {"pyth_value"},
